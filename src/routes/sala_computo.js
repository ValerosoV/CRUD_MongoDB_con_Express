...
const salas_computo = require("../model_schema/salas_computo"); //llamado al esquema en los modelos

//Ingresar una Nueva sala de computo a la DB (R de Register en el CRUP)
router.post("/salas_computo", (req, res) => {  /*peticion post que toma una ruta y una funcion flecha*/

    const sala =  salas_computo(req.body); /*crea una constante con el esquema de la sala de computo como body de la peticion*/
...
router.get("/salas_computo", (req, res) =>  {   //petición de tipo get
...
router.get("/salas_computo/:id", (req, res) => {
...
router.put("/salas_computo/:id", (req, res) => {
...
router.delete("/salas_computo/:id", (req, res) => {
